...
var action_1 = require("../Sidebar/action");
...
var CreateChartDialog = function (_a) {
    ...
    var _d = react_1.useState(null), notionToken = _d[0], setNotionToken = _d[1];
    ...
    react_1.useEffect(function () {
        setNotionToken(account === null || account === void 0 ? void 0 : account.notionToken);
    }, [account]);
    var addDataToChart = function (data) {
        setChart(__assign(__assign({}, chart), data));
    };
    var callback = function (currentChart) {
        setCurrentChart(currentChart);
        addChart(currentChart);
    };
    var onSubmit = function () {
        action_1.createChart(t("chart.newChartLong"), dataForChart.id, chart.type, dataForChart.order, callback);
    ...
    return (react_1["default"].createElement(dialog_1.Dialog, { open: isOpen, onOpenChange: function () { return setIsOpen(!isOpen); } },
        react_1["default"].createElement(dialog_1.DialogContent, { className: "lg:max-w-[750px]" },
            ...
            step === 1 && notionToken && (react_1["default"].createElement(step2_1["default"], { chartDatabase: chart.database, setChart: addDataToChart })),
            step === 1 && !notionToken && (react_1["default"].createElement(stepConnectNotion_1["default"], { setChart: setChart })),
