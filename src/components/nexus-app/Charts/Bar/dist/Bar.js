...
var NexusBar = function (_a) {
    ...
    var SvgComponent = function (props) {
        var fill = props.fill, x = props.x, y = props.y, width = props.width, height = props.height, strokeOpacity = props.strokeOpacity;
        var pathData = "\n\t\tM" + (x + 4) + "," + y + " \n\t\tH" + (x + width - 4) + " \n\t\tQ" + (x + width) + "," + y + " " + (x + width) + "," + (y + 4) + " \n\t\tV" + (y + height) + " \n\t\tH" + x + " \n\t\tV" + (y + 4) + " \n\t\tQ" + x + "," + y + " " + (x + 4) + "," + y + " \n\t\tZ\n\t  ";
        return (react_1["default"].createElement("path", { d: pathData, opacity: strokeOpacity, style: { fill: fill } }));
    };
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null, isLoading ? (react_1["default"].createElement(CircleLoader_1["default"], null)) :
        (react_1["default"].createElement(recharts_1.ResponsiveContainer, { width: "100%", height: "100%" },
            react_1["default"].createElement(recharts_1.BarChart, { data: data.data, margin: { top: 0, right: 0, bottom: ((_b = config.axeX) === null || _b === void 0 ? void 0 : _b.label) || config.legend.display ? 20 : 0, left: ((_c = config.axeY) === null || _c === void 0 ? void 0 : _c.label) ? 10 : 0 } },
                ...
                config.legend.display && react_1["default"].createElement(recharts_1.Legend, { content: react_1["default"].createElement(legend_1["default"], { setOpacityAll: setOpacityAll, config: config, styles: styles, type: "bar" }), verticalAlign: config.legend.verticalAlign }),
                react_1["default"].createElement(recharts_1.Tooltip, { cursor: { fill: styles.hoverColor + "20" }, content: react_1["default"].createElement(tooltip_1["default"], { styles: styles, labelType: (dataAxeX === null || dataAxeX === void 0 ? void 0 : dataAxeX.length) > 0 ? (_k = dataAxeX[0]) === null || _k === void 0 ? void 0 : _k.type : null }) }), propertiesSelected === null || propertiesSelected === void 0 ? void 0 :
                propertiesSelected.map(function (p, i) {
                    return react_1["default"].createElement(recharts_1.Bar, { barSize: 20, shape: react_1["default"].createElement(SvgComponent, { strokeOpacity: getOpacity(p.name) }), type: config.lineType, dataKey: p.name, fill: styles.colors[i].color, key: p.id });
                }))))));
};
exports["default"] = NexusBar;
